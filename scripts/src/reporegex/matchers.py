def submission_path_matcher(
    ...
    """
    Returns a regex string with groupings for the category, organization, chart
    ...
    Keyword Args
        ...
        include_version_matcher -- Whether or not the version matcher should be appended.
            In some cases, the caller of this regex doesn't care about the versioning detail.
    """
