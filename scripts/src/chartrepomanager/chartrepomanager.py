...
def prepare_chart_source_for_release(category, organization, chart, version):
    ...
    try:
        ...
        pass
    logging.info(f">>> filenames: {chart_file_name} {new_chart_file_name}")
    logging.info(f">>> ll .: {os.listdir()}")
    logging.info(f">>> ll .cr-release-packages: {os.listdir('.cr-release-packages')}")
...
def prepare_chart_tarball_for_release(category, organization, chart, version):
    ...
    try:
        ...
        pass
    logging.info(f">>> filenames: {chart_file_name} {new_chart_file_name}")
    logging.info(f">>> ll .: {os.listdir(path)}")
    logging.info(f">>> ll .cr-release-packages: {os.listdir('.cr-release-packages')}")
