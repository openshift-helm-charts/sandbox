"""This files contains the logic for packaging and releasing the Helm chart in the
...
# TODO: very badly named. Check history ?
# TODO: revisit.
def create_index_from_chart(chart_file_name):
    ...
    Returns:
        dict: content of Chart.yaml
    """
    print(
        "[INFO] create index from chart. %s"
        % (chart_file_name)
    )
    out = subprocess.run(
        [
...
def create_index_from_report(category, ocp_version_range, report_path):
    ...
    * Add digest to index entry if known.
    ...
    Returns:
        (dict, str): Index entry for this chart, and URL of this chart
