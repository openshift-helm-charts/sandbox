...
def get_support_information():
    cert_docs_link = "https://github.com/redhat-certification/chart-verifier/blob/main/docs/helm-chart-checks.md#types-of-helm-chart-checks"
...
- [Red Hat certification requirements and process for Kubernetes applications that are deployed using Helm charts.]({cert_docs_link}).
