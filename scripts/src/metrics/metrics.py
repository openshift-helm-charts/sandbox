...
def process_pr(write_key,repo,message_file,pr_number,action,prefix,pr_directory):
    ...
    if pr_content != "not-chart":
        ...
        if pr.merged_at:
            ...
            send_merge_metric(write_key,type,provider,chart,duration,pr_number,builds_out,pr_content,prefix)
...
def main():
    ...
    parser.add_argument("-d", "--pr_dir", dest="pr_dir", type=str, required=True,
