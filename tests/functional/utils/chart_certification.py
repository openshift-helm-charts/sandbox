...
"""
    ...
    def check_release_result(self, vendor, chart_name, chart_version, logger=pytest.fail):
...
class ChartCertificationE2ETestSingle(ChartCertificationE2ETest):
    ...
    def check_release_result(self):
        super().check_release_result(self.secrets.vendor, self.secrets.chart_name, self.secrets.chart_version, pytest.fail)
...
class ChartCertificationE2ETestMultiple(ChartCertificationE2ETest):
    ...
    def check_single_chart_result(self, vendor_type, vendor_name, chart_name, chart_version, pr_number, owners_table):
        ...
        if not super().check_release_result(vendor_name, chart_name, chart_version, logging.warning):
            return
