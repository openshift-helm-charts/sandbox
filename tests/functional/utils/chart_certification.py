...
class ChartCertificationE2ETestSingle(ChartCertificationE2ETest):
    ...
    def process_owners_file(self):
        super().create_and_push_owners_file(self.chart_directory, self.secrets.base_branch, self.secrets.vendor, self.secrets.vendor_type, self.secrets.chart_name, self.secrets.index_file,self.secrets.provider_delivery)
