...
class ChartCertificationE2ETestMultiple(ChartCertificationE2ETest):
    ...
    def report_failure(self,chart,chart_directory,chart_owners,failure_type,run_id,run_html_url):
        ...
        if not self.secrets.dry_run:
            ...
            create_verification_issue(chart_directory,  chart_owners, failure_type,self.secrets.notify_id, run_html_url, self.secrets.software_name,
        ...
        if self.secrets.software_name == "OpenShift":
            ...
            if failed_charts:
                for chart in failed_charts:
                    ...
                    self.get_owner_ids(chart_directory.owners_table)
                    chart_owners = owners_table[chart_directory]
                    self.report_failure(chart,chart_directory,chart_owners,BAD_KUBEVERSION,"","")
