...
@scenario('../features/report_and_chart_tar.feature', "[HC-015] A partner or redhat associate submits an error-free chart tarball with report")
...
@scenario('../features/report_and_chart_tar.feature', "[HC-016] A community user submits an error-free chart tarball with report")
