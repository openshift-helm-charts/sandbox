...
@scenario('../features/report_and_chart_src.feature', "[HC-013] A partner or redhat associate submits an error-free chart source with report")
...
@scenario('../features/report_and_chart_src.feature', "[HC-014] A community user submits an error-free chart source with report")
