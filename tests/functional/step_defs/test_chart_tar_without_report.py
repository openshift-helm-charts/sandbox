...
@scenario('../features/chart_tar_without_report.feature', "[HC-003] A partner or redhat associate submits an error-free chart tarball")
def test_partner_or_redhat_user_submits_chart_tarball():
    """A partner or redhat associate submits an error-free chart tarball."""

@scenario('../features/chart_tar_without_report.feature', "[HC-004] A community user submits an error-free chart tarball without report")
