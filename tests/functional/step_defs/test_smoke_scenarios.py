...
def provider_delivery_control_set_in_owners(workflow_test,provider_control_owners):
    print(f"[INFO] provider_control_owners = {provider_control_owners}")
    if provider_control_owners:
        print(f"[INFO] provider_control_owners is set")
        if provider_control_owners == "true":
            print(f"[INFO] provider_control_owners is string true")
