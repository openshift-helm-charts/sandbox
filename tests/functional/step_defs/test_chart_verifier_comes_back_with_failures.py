...
@scenario('../features/chart_verifier_comes_back_with_failures.feature', "[HC-005] A partner or community user submits a chart which does not contain a readme file")
...
@scenario('../features/chart_verifier_comes_back_with_failures.feature', "[HC-006] A redhat user submits a chart which does not contain a readme file")
