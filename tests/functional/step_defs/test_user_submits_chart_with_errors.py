...
@scenario('../features/user_submits_chart_with_errors.feature', "[HC-023] An unauthorized user submits a chart")
def test_chart_submission_by_unauthorized_user():
    """An unauthorized user submits a chart"""

@scenario('../features/user_submits_chart_with_errors.feature', "[HC-024] An authorized user submits a chart with incorrect version")
