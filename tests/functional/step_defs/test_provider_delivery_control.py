...
@scenario('../features/provider_delivery_control.feature', "[HC-010] A partner associate submits an error-free report with provider controlled delivery")
...
@scenario('../features/provider_delivery_control.feature', "[HC-011] A partner associate submits an error-free report and chart with provider controlled delivery")
...
@scenario('../features/provider_delivery_control.feature', "[HC-012] A partner associate submits an error-free report with inconsistent provider controlled delivery setting")
