Feature: Report only submission
    ...
    Scenario Outline: [HC-12-001] A partner or redhat associate submits an error-free report
        ...
        Examples:
            ...
            | partners     | hashicorp | tests/data/common/report.yaml |
        
        @redhat @full
        Examples:
            | vendor_type  | vendor    | report_path                   |
            | redhat       | redhat    | tests/data/common/report.yaml |
    ...
    Scenario Outline: [HC-12-002] A community user submits an error-free report
        ...
        Examples:
            ...
            | community   | redhat  | tests/data/common/report.yaml | Community charts require maintainer review and approval, a review will be conducted shortly |